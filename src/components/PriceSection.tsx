...
export default function PriceSection() {
  ...
  const pricingPlans = [
    ...
    {
      title: "Profesjonalny Detailing",
      description: "Kompleksowy detailing motocykla",
      icon: Star,
      price: "Od 450 zł",
    ...
    },
    {
      ...
      popular: false,
      features: [
        "Długotrwała ochrona lakieru",
        "Odporność na promieniowanie UV",
        "Zwiększona głębia koloru i połysk",
